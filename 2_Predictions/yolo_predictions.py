...
class YOLO_Pred():
    def __init__(self, onnx_model, data_yaml):
        ...
        self.yolo = cv2.dnn.readNetFromONNX('./2_predictions/Model/weights/best.onnx')
    ...
    def predictions(self, image):
        ...
        preds = self.yolo.forward() #detections or predictions from yolo
        ...
        for ind in index:
            ...
            colors = self.generate_colours(class_id)
